...
const JobCard = ({job} : {job: Offer}) => {
	...
	return (
		<Link prefetch={true} href={`/offer/${id}`} className="card flex grow justify-start items-stretch">
			<article className="card__body p-4 shadow-sm shadow-gray-400 dark:shadow-gray-800 bg-white-50 dark:bg-gray-800 rounded-lg flex flex-col justify-start items-start gap-4 relative outline-none focus:ring ring-blue-500">
